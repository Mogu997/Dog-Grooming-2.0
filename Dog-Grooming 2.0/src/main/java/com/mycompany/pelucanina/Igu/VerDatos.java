...
public class VerDatos extends javax.swing.JFrame {
    ...
    private void cargarTabla() {
       DefaultTableModel modeloTabla = new DefaultTableModel(){
        ...
        String titulos[]={"Num", "Nombre", "Color", "Raza", "At. Esp.", "Duenio", "Celular"};
        modeloTabla.setColumnIdentifiers(titulos);
        
        List <Mascota> listaMascota = control.traerMascotas();
        if(listaMascota != null){
            for (Mascota masco : listaMascota){
                Object[] objeto={masco.getNum_cliente(), masco.getNombre(), masco.getColor(), masco.getRaza(), masco.getAtencion_especial(), masco.getUnDuenio().getNombre(), masco.getUnDuenio().getCelDuenio()};
